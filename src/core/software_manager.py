...
The module degrades gracefully on non-Windows platforms.
"""
import os
import platform
import subprocess
...
class SoftwareManager:
    ...
    def __init__(self, show_system_software: bool = False):
        ...
        self.software_list: List[SoftwareInfo] = []

    def _require_windows(self):
        if not IS_WINDOWS:
            raise EnvironmentError("Software inventory is only available on Windows.")
